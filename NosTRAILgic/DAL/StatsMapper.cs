...
{
    /************************************************************************************
     * Description: Mapper for Statistics                                               *
     *                                                                                  *
     * Developer: Khaleef                                                                *
     *                                                                                  *
     * Date: 02/04/2016                                                                 *
    ...
    public class StatsMapper : DataGateway<Statistic>
    {
        ...
        {
            LogWriter.Instance.LogInfo("StatsMapper / GetStatsByTopSearchLocation");
        ...
        {
            LogWriter.Instance.LogInfo("StatsMapper / GetStatsByTopTrailContributor");
        ...
        {
            LogWriter.Instance.LogInfo("StatsMapper / GetSearchLocationDay");
        ...
        {
            LogWriter.Instance.LogInfo("StatsMapper / GetStatsByCheckInCurrentYear");
        ...
        {
            LogWriter.Instance.LogInfo("StatsMapper / GetStatsByCheckInPreviousYear");
