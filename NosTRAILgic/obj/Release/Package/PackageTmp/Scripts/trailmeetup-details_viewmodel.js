...
function initMarker() {
    ...
    $.each(detailsViewModel.enumerableAllLocationFromTrail, function (i, location) {
        ...
        google.maps.event.addListener(markers[i], 'click', function () {
            ...
            var re = /-?\d+/;
            var m = re.exec(detailsViewModel.enumerableAllWeatherFromTrail[i].LastUpdated);
            ...
            var content1 =
            '<hr/>' +
            '<table style="width:70%;" cellpadding="10" id="detailtable" align="center">' +
                '<tr>' +
            ...
            var content2 =
                     ...
                     '<td rowspan="2" align="center" width:"20%">' +
                        '<div><img src="' + detailsViewModel.enumerableAllWeatherFromTrail[i].Icon + '"/></div>' +
                         '<div>' + detailsViewModel.enumerableAllWeatherFromTrail[i].Forecast + ' </div><br>' +
