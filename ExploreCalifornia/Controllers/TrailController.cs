...
namespace ExploreCalifornia.Controllers
{
    public class TrailController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Location,TrailLocation,TrailName,Description")] Trail trail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Location,TrailLocation,TrailName,Description")] Trail trail)
        {
            if (ModelState.IsValid)
            {
